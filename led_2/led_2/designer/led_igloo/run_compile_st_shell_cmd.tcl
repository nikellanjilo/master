...
save
set has_violations {C:\Projects\Verilog\led_IGLOO\led_2\led_2\designer\led_igloo\led_igloo_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {C:\Projects\Verilog\led_IGLOO\led_2\led_2\designer\led_igloo\led_igloo_combinational_loops.xml}
if { [catch "file delete -force -- {C:\Projects\Verilog\led_IGLOO\led_2\led_2\designer\led_igloo\pinslacks.txt}"] } {
   ;
}
report -type slack {C:\Projects\Verilog\led_IGLOO\led_2\led_2\designer\led_igloo\pinslacks.txt}
