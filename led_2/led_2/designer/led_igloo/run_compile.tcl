...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Projects\Verilog\led_IGLOO\led_2\led_2\synthesis\led_igloo.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Projects\Verilog\led_IGLOO\led_2\led_2\constraint\io\led_igloo.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Projects\Verilog\led_IGLOO\led_2\led_2\constraint\fp\led_igloo.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4MGL5000 \
    -pkg fg896 \
    -pdc_file {C:\Projects\Verilog\led_IGLOO\led_2\led_2\constraint\io\led_igloo.io.pdc} \
    -pdc_file {C:\Projects\Verilog\led_IGLOO\led_2\led_2\constraint\fp\led_igloo.fp.pdc} \
    -merge_pdc 0
